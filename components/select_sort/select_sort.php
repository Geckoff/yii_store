<div class="item-filters">
    <select name="sort" id="filters" class="selectpicker2  store-picker filter-picker">
        <option value="dflt" <?php if ($this->gets['sort'] == 'dflt') echo 'selected' ?>>Default</option>
        <option value="ascp" <?php if ($this->gets['sort'] == 'ascp') echo 'selected' ?>>Price: asc</option>
        <option value="descp" <?php if ($this->gets['sort'] == 'descp') echo 'selected' ?>>Price: desc</option>
